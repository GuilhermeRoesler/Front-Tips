                    ...
                    <div>
                        <form action="">
                            <label for="super-happy1">
                                <input type="radio" name="selecting" className="super-happy" id="super-happy1" value="super-happy1" />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="happy1">
                                <input type="radio" name="selecting" className="happy" id="happy1" value="happy1" />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="neutral1">
                                <input type="radio" name="selecting" className="neutral" id="neutral1" value="neutral1" checked />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="sad1">
                                <input type="radio" name="selecting" className="sad" id="sad1" value="sad1" />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="super-sad1">
                                <input type="radio" name="selecting" className="super-sad" id="super-sad1" value="super-sad1" />
                                <svg viewBox="0 0 24 24">
                                    <path

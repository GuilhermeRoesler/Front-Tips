...
const RadioButton1 = () => {
    return (
        <>
            <h1>Radio Button 1</h1>
            <section id="RadioButton1">
                <div className="card">
                    <p>I'm feeling...</p>
                    <div>
                        <form action="">
                            <label for="super-happy">
                                <input type="radio" name="rating1" className="super-happy" id="super-happy" value="super-happy" />
                            ...
                            <label for="happy">
                                <input type="radio" name="rating1" className="happy" id="happy" value="happy" checked />
                                <svg version="1.1"
                            ...
                            <label for="neutral">
                                <input type="radio" name="rating1" className="neutral" id="neutral" value="neutral" />
                                <svg version="1.1"
                                    width="100%" height="100%" viewBox="0 0 24 24">
                                    <path
                                ...
                                <input type="radio" name="rating1" className="sad" id="sad" value="sad" />
                                <svg version="1.1"
                                    width="100%" height="100%" viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="super-sad">
                                <input type="radio" name="rating1" className="super-sad" id="super-sad" value="super-sad" />
                                <svg viewBox="0 0 24 24">
                                    <path
                    ...
                    <div>
                        <form action="">
                            <label for="super-happy1">
                                <input type="radio" name="rating2" className="super-happy" id="super-happy1" value="super-happy1" />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="happy1">
                                <input type="radio" name="rating2" className="happy" id="happy1" value="happy1" />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="neutral1">
                                <input type="radio" name="rating2" className="neutral" id="neutral1" value="neutral1" checked />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="sad1">
                                <input type="radio" name="rating2" className="sad" id="sad1" value="sad1" />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="super-sad1">
                                <input type="radio" name="rating2" className="super-sad" id="super-sad1" value="super-sad1" />
                                <svg viewBox="0 0 24 24">
                                    <path
                    ...
                    <div>
                        <form action="">
                            <label for="super-happy2">
                                <input type="radio" name="liking" className="super-happy" id="super-happy2" value="super-happy2"
                                    checked />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="happy2">
                                <input type="radio" name="liking" className="happy" id="happy2" value="happy2" />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="neutral2">
                                <input type="radio" name="liking" className="neutral" id="neutral2" value="neutral2" />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="sad2">
                                <input type="radio" name="liking" className="sad" id="sad2" value="sad2" />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="super-sad2">
                                <input type="radio" name="liking" className="super-sad" id="super-sad2" value="super-sad2" />
                                <svg viewBox="0 0 24 24">
                                    <path

      ...
      <div>
        ...
        <details>
          ...
          <p>
            ...
            using calc-size(), which has some extra things you could do with it,
            but right now the easiest way is to use a combination of
            interpolate-size: allow-keywords; and transition-behavior:
            allow-discrete.
          </p>
        </details>
        <details>
          ...
          <p>
            ...
            but it'll only get better from here. Also, it is a great progressive
            enhancement. This means that it won't break anything for people on
            older browsers, they just won't get the fancy animation you've
            created, while people on newer browser will get it!
          </p>
        </details>
        <details>
          ...
          <p>
            ...
            extra filler text lang="la" Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Quae totam ad minima corporis facilis nostrum. Et
            aperiam animi alias voluptatem!
          </p>
        </details>
      </div>
    </>

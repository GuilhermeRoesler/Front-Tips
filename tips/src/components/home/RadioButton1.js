                    ...
                    <div>
                        <form action="">
                            <label for="super-happy1">
                                <input type="radio" name="rating" className="super-happy" id="super-happy1" value="super-happy1" />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="happy1">
                                <input type="radio" name="rating" className="happy" id="happy1" value="happy1" />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="neutral1">
                                <input type="radio" name="rating" className="neutral" id="neutral1" value="neutral1" checked />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="sad1">
                                <input type="radio" name="rating" className="sad" id="sad1" value="sad1" />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="super-sad1">
                                <input type="radio" name="rating" className="super-sad" id="super-sad1" value="super-sad1" />
                                <svg viewBox="0 0 24 24">
                                    <path
                    ...
                    <div>
                        <form action="">
                            <label for="super-happy2">
                                <input type="radio" name="rating" className="super-happy" id="super-happy2" value="super-happy2"
                                    checked />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="happy2">
                                <input type="radio" name="rating" className="happy" id="happy2" value="happy2" />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="neutral2">
                                <input type="radio" name="rating" className="neutral" id="neutral2" value="neutral2" />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="sad2">
                                <input type="radio" name="rating" className="sad" id="sad2" value="sad2" />
                                <svg viewBox="0 0 24 24">
                                    <path
                            ...
                            <label for="super-sad2">
                                <input type="radio" name="rating" className="super-sad" id="super-sad2" value="super-sad2" />
                                <svg viewBox="0 0 24 24">
                                    <path
